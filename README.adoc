...
You will need Rust 1.41.1 or later, Cargo, GNU Make, and Git. If you additionally
...
Scutiger utilities are designed to compile with Rust 1.41.1 or later. They may
